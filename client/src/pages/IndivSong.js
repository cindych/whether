    ...
    return (
        <div className="indiv-song-page" style={{ minWidth: '800px' }}>
            ...
            <div className="data-results">
                ...
                { showSongStat && songStatResults.length > 0 &&
                    <Paper className="song-stat-container" elevation={4} sx={{ width: '90%', overflow: 'hidden', margin: '0 auto', padding: 3, marginTop: '20px' }}>
