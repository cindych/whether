...
const getSongAvgWeatherStat = async (statistic, location, weather) => {
    var res = await fetch(`http://${config.server_host}:${config.server_port}/songAvgWeatherStat?statistic=${statistic}&location=${location}&weather=${weather}`, {
        method: 'GET',
    })
    return res.json()
}
